    ...
    expenses: [
      {
        ...
        location: "Ahmeds' tuition center",
        total: 100.0,
  ...
  },
  {
    ...
    expenses: [
      ...
      },
      {
        ...
        location: "Ahmeds' Baby Care Store",
        total: 100.0,
        status: pendingStatus,
      },
      {
        ...
        <TouchableOpacity
          style={[
            {
              ...
              paddingHorizontal: SIZES.padding,
              backgroundColor:
                selectedCategory == item ? item.color : COLORS.white,
              borderRadius: 5,
            },
            styles.shadow,
          ]}
          ...
          <Image
            ...
            style={{
              width: 20,
              height: 20,
              tintColor: selectedCategory == item ? COLORS.white : item.color,
            }}
          />
          <Text
            style={{
